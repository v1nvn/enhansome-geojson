# awesome geojson [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 445,096 | 🐛 77 | 📅 2026-03-09
...
* [turf](https://github.com/Turfjs/turf) ⭐ 10,283 | 🐛 295 | 🌐 TypeScript | 📅 2026-03-13: collection of functions for spatial operations and analysi
...
* [antimeridian](https://github.com/gadomski/antimeridian) ⭐ 106 | 🐛 3 | 🌐 Python | 📅 2026-03-12: Fix GeoJSON polygons that cross the antimeridian (Python package)
...
* [topojson](https://github.com/topojson/topojson) ⭐ 4,868 | 🐛 16 | 🌐 JavaScript | 📅 2024-09-20: convert GeoJSON to & from TopoJSON, join data from CSV
...
* [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,021 | 🐛 19 | 🌐 JavaScript | 📅 2024-06-26: Slice GeoJSON into vector tiles on the fly in the browser
* [ogr2ogr](http://www.gdal.org/ogr2ogr.html): convert anything to anything
  * [fiona](https://github.com/toblerity/fiona) ⭐ 1,228 | 🐛 49 | 🌐 Python | 📅 2025-02-20: nice python interface on top of ogr
* **OpenStreetMap**
...
* [france-geojson](https://github.com/gregoiredavid/france-geojson) ⭐ 808 | 🐛 17 | 📅 2022-12-02: Outlines of regions, departments, arrondissements, cantons and communes of France (mainland and overseas departments) in GeoJSON format
* [historical-basemaps](https://github.com/aourednik/historical-basemaps) ⭐ 680 | 🐛 14 | 🌐 JavaScript | 📅 2026-01-26: Collection of georeferenced boundaries of world countries and cultural regions for use in mapping historical data on the world scale.
...
* [mapbox-java](https://github.com/mapbox/mapbox-java) ⭐ 439 | 🐛 82 | 🌐 Java | 📅 2026-02-06: serialize GeoJSON to and from Java datatypes (based on [Gson](https://github.com/google/gson) ⭐ 24,340 | 🐛 332 | 🌐 Java | 📅 2026-03-10)
