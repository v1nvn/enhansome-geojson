# awesome geojson [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 436,352 | 🐛 69 | 📅 2026-01-28
...
* [turf](https://github.com/Turfjs/turf) ⭐ 10,224 | 🐛 282 | 🌐 TypeScript | 📅 2026-02-08: collection of functions for spatial operations and analysi
...
* [de9im](https://github.com/dpmcmlxxvi/de9im) ⭐ 31 | 🐛 3 | 🌐 JavaScript | 📅 2022-07-07: collection of fast functions for spatial javascript operations
...
* [rfc7946-to-d3](https://github.com/tyrasd/rfc7946-to-d3) ⭐ 11 | 🐛 0 | 🌐 JavaScript | 📅 2018-05-28: Converts polygon winding order between rfc7946 and [d3 compatible](https://github.com/d3/d3-geo#d3-geo) ⭐ 1,085 | 🐛 34 | 🌐 JavaScript | 📅 2024-06-28 conventions.
...
* [Vector Tile Lab](https://github.com/spider-hand/vector-tile-lab) ⭐ 32 | 🐛 0 | 🌐 Vue | 📅 2026-02-03: An interactive sandbox to tune vector tiles
...
* [geojson-pydantic](https://github.com/developmentseed/geojson-pydantic) ⭐ 274 | 🐛 6 | 🌐 Python | 📅 2025-10-08: [Pydantic](https://docs.pydantic.dev/latest/) models for GeoJSON
...
* [antimeridian](https://github.com/gadomski/antimeridian) ⭐ 104 | 🐛 3 | 🌐 Python | 📅 2025-12-15: Fix GeoJSON polygons that cross the antimeridian (Python package)
* [check-geojson](https://github.com/placemark/check-geojson) ⭐ 83 | 🐛 6 | 🌐 TypeScript | 📅 2025-02-18: alternative to geojsonhint
...
* [topojson](https://github.com/topojson/topojson) ⭐ 4,860 | 🐛 17 | 🌐 JavaScript | 📅 2024-09-20: convert GeoJSON to & from TopoJSON, join data from CSV
...
* [ogr2ogr](http://www.gdal.org/ogr2ogr.html): convert anything to anything
  * [fiona](https://github.com/toblerity/fiona) ⭐ 1,223 | 🐛 47 | 🌐 Python | 📅 2025-02-20: nice python interface on top of ogr
* **OpenStreetMap**
  * [osmtogeojson](https://github.com/tyrasd/osmtogeojson) ⭐ 740 | 🐛 58 | 🌐 JavaScript | 📅 2024-06-28: convert OpenStreetMap data to GeoJSON
  * [query-overpass](https://github.com/perliedman/query-overpass) ⭐ 159 | 🐛 6 | 🌐 JavaScript | 📅 2023-03-28 CLI to make Overpass query and transform result to GeoJSON. Based on [osmtogeojson](https://github.com/tyrasd/osmtogeojson) ⭐ 740 | 🐛 58 | 🌐 JavaScript | 📅 2024-06-28
  * [osm2geojson](https://github.com/aspectumapp/osm2geojson) ⭐ 113 | 🐛 2 | 🌐 Python | 📅 2025-10-31: (Python) converts OSM XML and Overpass XML/JSON to GeoJSON
...
* [togeojson](https://github.com/tmcw/togeojson) ⭐ 437 | 🐛 13 | 🌐 TypeScript | 📅 2025-05-31: convert GPX & KML to geojson
* **CSV**
...
* [topojson for Python](https://github.com/mattijn/topojson) ⭐ 196 | 🐛 5 | 🌐 Python | 📅 2025-07-22: Topojson is a library that is capable of creating a topojson encoded format of merely any spatial object in Python.
...
* [historical-basemaps](https://github.com/aourednik/historical-basemaps) ⭐ 666 | 🐛 12 | 🌐 JavaScript | 📅 2026-01-26: Collection of georeferenced boundaries of world countries and cultural regions for use in mapping historical data on the world scale.
...
* [python-geojson](https://github.com/frewsxcv/python-geojson) ⭐ 984 | 🐛 30 | 🌐 Python | 📅 2026-01-05: serialize geojson to/from python datatypes
* [mapbox-java](https://github.com/mapbox/mapbox-java) ⭐ 438 | 🐛 82 | 🌐 Java | 📅 2026-02-06: serialize GeoJSON to and from Java datatypes (based on [Gson](https://github.com/google/gson) ⭐ 24,338 | 🐛 332 | 🌐 Java | 📅 2026-02-01)
* [rust-geojson](https://github.com/georust/rust-geojson) ⭐ 326 | 🐛 28 | 🌐 Rust | 📅 2026-01-31: serialize geojson to/from rust datatypes
* [geojson-jackson](https://github.com/opendatalab-de/geojson-jackson) ⭐ 272 | 🐛 25 | 🌐 Java | 📅 2025-12-11: serialize GeoJSON to and from Java datatypes (based on [Jackson](http://wiki.fasterxml.com/JacksonHome))
...
* [geojson-invalid-geometry](https://github.com/chrieke/geojson-invalid-geometry) ⭐ 46 | 🐛 1 | 📅 2024-12-31: List of GeoJSON invalid geometry issues with example files.
