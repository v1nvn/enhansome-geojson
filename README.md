# awesome geojson [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 444,206 | 🐛 75 | 📅 2026-03-09
...
* [turf](https://github.com/Turfjs/turf) ⭐ 10,278 | 🐛 293 | 🌐 TypeScript | 📅 2026-03-05: collection of functions for spatial operations and analysi
...
* [geojson-rewind](https://github.com/mapbox/geojson-rewind) ⭐ 132 | 🐛 5 | 🌐 JavaScript | 📅 2023-07-30: enforce ring winding order
* [CoGran](https://github.com/berlinermorgenpost/cogran) ⭐ 112 | 🐛 7 | 🌐 JavaScript | 📅 2019-04-04: Resample statistics from one set of GeoJSON polygons to another
...
* [turf\_dart](https://github.com/dartclub/turf_dart) ⭐ 82 | 🐛 56 | 🌐 Dart | 📅 2025-04-18: a turf.js port for Dart and Flutter
...
* [geojson-summary](https://github.com/mapbox/geojson-summary) ⭐ 35 | 🐛 0 | 🌐 JavaScript | 📅 2023-03-24: get a plain-english summary of what's in a geojson file
* [geojson-normalize](https://github.com/mapbox/geojson-normalize) ⭐ 34 | 🐛 2 | 🌐 JavaScript | 📅 2024-11-22: normalize any geojson object into a geojson featurecollection
* [geojson-coords](https://github.com/mapbox/geojson-coords) ⭐ 33 | 🐛 2 | 🌐 JavaScript | 📅 2021-09-13: Extract coordinates from GeoJSON
...
* [rfc7946-to-d3](https://github.com/tyrasd/rfc7946-to-d3) ⭐ 11 | 🐛 0 | 🌐 JavaScript | 📅 2018-05-28: Converts polygon winding order between rfc7946 and [d3 compatible](https://github.com/d3/d3-geo#d3-geo) ⭐ 1,088 | 🐛 34 | 🌐 JavaScript | 📅 2024-06-28 conventions.
...
* [Vector Tile Lab](https://github.com/spider-hand/vector-tile-lab) ⭐ 38 | 🐛 0 | 🌐 Vue | 📅 2026-03-03: An interactive sandbox to tune vector tiles
...
* [geojson-pydantic](https://github.com/developmentseed/geojson-pydantic) ⭐ 278 | 🐛 6 | 🌐 Python | 📅 2025-10-08: [Pydantic](https://docs.pydantic.dev/latest/) models for GeoJSON
* [geojsonhint](https://github.com/mapbox/geojsonhint) ⚠️ Archived: find errors in your geojson files
* [antimeridian](https://github.com/gadomski/antimeridian) ⭐ 105 | 🐛 3 | 🌐 Python | 📅 2026-03-03: Fix GeoJSON polygons that cross the antimeridian (Python package)
...
* [featureserver](https://github.com/featureserver/featureserver) ⭐ 103 | 🐛 27 | 🌐 JavaScript | 📅 2023-07-13: An open source Esri-Style Feature Server
...
* [topojson](https://github.com/topojson/topojson) ⭐ 4,867 | 🐛 16 | 🌐 JavaScript | 📅 2024-09-20: convert GeoJSON to & from TopoJSON, join data from CSV
* [supercluster](https://github.com/mapbox/supercluster) ⭐ 2,309 | 🐛 42 | 🌐 JavaScript | 📅 2024-08-15: A fast GeoJSON clustering library for browsers and Node.
* [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,019 | 🐛 19 | 🌐 JavaScript | 📅 2024-06-26: Slice GeoJSON into vector tiles on the fly in the browser
* [ogr2ogr](http://www.gdal.org/ogr2ogr.html): convert anything to anything
  * [fiona](https://github.com/toblerity/fiona) ⭐ 1,227 | 🐛 49 | 🌐 Python | 📅 2025-02-20: nice python interface on top of ogr
* **OpenStreetMap**
  * [osmtogeojson](https://github.com/tyrasd/osmtogeojson) ⭐ 739 | 🐛 58 | 🌐 JavaScript | 📅 2024-06-28: convert OpenStreetMap data to GeoJSON
  * [query-overpass](https://github.com/perliedman/query-overpass) ⭐ 158 | 🐛 6 | 🌐 JavaScript | 📅 2023-03-28 CLI to make Overpass query and transform result to GeoJSON. Based on [osmtogeojson](https://github.com/tyrasd/osmtogeojson) ⭐ 739 | 🐛 58 | 🌐 JavaScript | 📅 2024-06-28
  * [osm2geojson](https://github.com/aspectumapp/osm2geojson) ⭐ 113 | 🐛 2 | 🌐 Python | 📅 2026-03-04: (Python) converts OSM XML and Overpass XML/JSON to GeoJSON
...
* **CSV**
  * [csv2geojson](https://github.com/mapbox/csv2geojson) ⭐ 373 | 🐛 17 | 🌐 JavaScript | 📅 2025-10-07: convert CSV to geojson
  * [geojson2dsv](https://github.com/tmcw/geojson2dsv) ⭐ 8 | 🐛 1 | 🌐 JavaScript | 📅 2017-05-03: convert geojson to CSV and TSV
* [wellknown](https://github.com/mapbox/wellknown) ⭐ 279 | 🐛 11 | 🌐 JavaScript | 📅 2021-10-29: convert WKT to GeoJSON
* [esri2open](https://github.com/project-open-data/esri2open) ⚠️ Archived converts proprietary Esri formats to GeoJSON
* **SVG**
  * [geojson2svg](https://github.com/gagan-bansal/geojson2svg) ⭐ 249 | 🐛 0 | 🌐 JavaScript | 📅 2025-08-02: Converts GeoJSON to SVG string given SVG view port size and maps extent.
...
* [tokml](https://github.com/mapbox/tokml) ⭐ 192 | 🐛 10 | 🌐 JavaScript | 📅 2018-05-06: convert GeoJSON to KML
...
* [betterknown](https://github.com/placemark/betterknown) ⭐ 54 | 🐛 4 | 🌐 TypeScript | 📅 2025-12-17: convert WKT to GeoJSON (successor to wellknown)
...
* [geo-maps](https://github.com/simonepri/geo-maps) ⭐ 1,342 | 🐛 16 | 🌐 JavaScript | 📅 2019-05-29: High Quality GeoJSON maps programmatically generated.
* [world-atlas](https://github.com/topojson/world-atlas) ⚠️ Archived: customizable simplified versions of natural earth data
* [us-atlas](https://github.com/topojson/us-atlas) ⭐ 917 | 🐛 9 | 🌐 Shell | 📅 2024-01-02: geojson & topojson for United States features
* [france-geojson](https://github.com/gregoiredavid/france-geojson) ⭐ 805 | 🐛 17 | 📅 2022-12-02: Outlines of regions, departments, arrondissements, cantons and communes of France (mainland and overseas departments) in GeoJSON format
* [historical-basemaps](https://github.com/aourednik/historical-basemaps) ⭐ 676 | 🐛 14 | 🌐 JavaScript | 📅 2026-01-26: Collection of georeferenced boundaries of world countries and cultural regions for use in mapping historical data on the world scale.
...
* [mapbox-java](https://github.com/mapbox/mapbox-java) ⭐ 439 | 🐛 82 | 🌐 Java | 📅 2026-02-06: serialize GeoJSON to and from Java datatypes (based on [Gson](https://github.com/google/gson) ⭐ 24,338 | 🐛 331 | 🌐 Java | 📅 2026-03-09)
* [rust-geojson](https://github.com/georust/rust-geojson) ⭐ 327 | 🐛 25 | 🌐 Rust | 📅 2026-03-03: serialize geojson to/from rust datatypes
...
* [geojson-invalid-geometry](https://github.com/chrieke/geojson-invalid-geometry) ⭐ 48 | 🐛 1 | 📅 2024-12-31: List of GeoJSON invalid geometry issues with example files.
