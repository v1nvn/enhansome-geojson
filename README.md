# awesome geojson [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 458,412 | 🐛 66 | 📅 2026-04-19
...
* [turf](https://github.com/Turfjs/turf) ⭐ 10,337 | 🐛 300 | 🌐 TypeScript | 📅 2026-04-23: collection of functions for spatial operations and analysi
...
* [rfc7946-to-d3](https://github.com/tyrasd/rfc7946-to-d3) ⭐ 11 | 🐛 0 | 🌐 JavaScript | 📅 2018-05-28: Converts polygon winding order between rfc7946 and [d3 compatible](https://github.com/d3/d3-geo#d3-geo) ⭐ 1,093 | 🐛 34 | 🌐 JavaScript | 📅 2024-06-28 conventions.
...
* [geojson-pydantic](https://github.com/developmentseed/geojson-pydantic) ⭐ 280 | 🐛 7 | 🌐 Python | 📅 2026-04-17: [Pydantic](https://docs.pydantic.dev/latest/) models for GeoJSON
...
* [topojson](https://github.com/topojson/topojson) ⭐ 4,877 | 🐛 16 | 🌐 JavaScript | 📅 2024-09-20: convert GeoJSON to & from TopoJSON, join data from CSV
...
* [historical-basemaps](https://github.com/aourednik/historical-basemaps) ⭐ 703 | 🐛 32 | 🌐 JavaScript | 📅 2026-01-26: Collection of georeferenced boundaries of world countries and cultural regions for use in mapping historical data on the world scale.
...
* [mapbox-java](https://github.com/mapbox/mapbox-java) ⭐ 440 | 🐛 83 | 🌐 Java | 📅 2026-02-06: serialize GeoJSON to and from Java datatypes (based on [Gson](https://github.com/google/gson) ⭐ 24,211 | 🐛 336 | 🌐 Java | 📅 2026-04-23)
* [rust-geojson](https://github.com/georust/rust-geojson) ⭐ 335 | 🐛 24 | 🌐 Rust | 📅 2026-04-21: serialize geojson to/from rust datatypes
