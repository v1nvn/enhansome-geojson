# awesome geojson [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 459,344 | 🐛 67 | 📅 2026-04-19
...
* [turf](https://github.com/Turfjs/turf) ⭐ 10,343 | 🐛 301 | 🌐 TypeScript | 📅 2026-04-24: collection of functions for spatial operations and analysi
...
* [geojson-rewind](https://github.com/mapbox/geojson-rewind) ⭐ 133 | 🐛 5 | 🌐 JavaScript | 📅 2026-04-13: enforce ring winding order
...
* [turf\_dart](https://github.com/dartclub/turf_dart) ⭐ 82 | 🐛 55 | 🌐 Dart | 📅 2026-04-21: a turf.js port for Dart and Flutter
...
* [geojson-coords](https://github.com/mapbox/geojson-coords) ⭐ 33 | 🐛 2 | 🌐 JavaScript | 📅 2026-04-13: Extract coordinates from GeoJSON
...
* [rfc7946-to-d3](https://github.com/tyrasd/rfc7946-to-d3) ⭐ 11 | 🐛 0 | 🌐 JavaScript | 📅 2018-05-28: Converts polygon winding order between rfc7946 and [d3 compatible](https://github.com/d3/d3-geo#d3-geo) ⭐ 1,094 | 🐛 34 | 🌐 JavaScript | 📅 2024-06-28 conventions.
...
* [Vector Tile Lab](https://github.com/spider-hand/vector-tile-lab) ⭐ 40 | 🐛 0 | 🌐 Vue | 📅 2026-03-03: An interactive sandbox to tune vector tiles
...
* [geojson-pydantic](https://github.com/developmentseed/geojson-pydantic) ⭐ 280 | 🐛 7 | 🌐 Python | 📅 2026-04-24: [Pydantic](https://docs.pydantic.dev/latest/) models for GeoJSON
* [geojsonhint](https://github.com/mapbox/geojsonhint) ⚠️ Archived: find errors in your geojson files
* [antimeridian](https://github.com/gadomski/antimeridian) ⭐ 107 | 🐛 4 | 🌐 Python | 📅 2026-04-21: Fix GeoJSON polygons that cross the antimeridian (Python package)
...
* [topojson](https://github.com/topojson/topojson) ⭐ 4,878 | 🐛 16 | 🌐 JavaScript | 📅 2024-09-20: convert GeoJSON to & from TopoJSON, join data from CSV
* [supercluster](https://github.com/mapbox/supercluster) ⭐ 2,318 | 🐛 42 | 🌐 JavaScript | 📅 2024-08-15: A fast GeoJSON clustering library for browsers and Node.
* [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,029 | 🐛 20 | 🌐 JavaScript | 📅 2024-06-26: Slice GeoJSON into vector tiles on the fly in the browser
* [ogr2ogr](http://www.gdal.org/ogr2ogr.html): convert anything to anything
  * [fiona](https://github.com/toblerity/fiona) ⭐ 1,236 | 🐛 49 | 🌐 Python | 📅 2025-02-20: nice python interface on top of ogr
* **OpenStreetMap**
  * [osmtogeojson](https://github.com/tyrasd/osmtogeojson) ⭐ 741 | 🐛 59 | 🌐 JavaScript | 📅 2026-04-23: convert OpenStreetMap data to GeoJSON
  * [query-overpass](https://github.com/perliedman/query-overpass) ⭐ 157 | 🐛 6 | 🌐 JavaScript | 📅 2023-03-28 CLI to make Overpass query and transform result to GeoJSON. Based on [osmtogeojson](https://github.com/tyrasd/osmtogeojson) ⭐ 741 | 🐛 59 | 🌐 JavaScript | 📅 2026-04-23
  * [osm2geojson](https://github.com/aspectumapp/osm2geojson) ⭐ 115 | 🐛 2 | 🌐 Python | 📅 2026-03-04: (Python) converts OSM XML and Overpass XML/JSON to GeoJSON
...
* **CSV**
  * [csv2geojson](https://github.com/mapbox/csv2geojson) ⭐ 373 | 🐛 17 | 🌐 JavaScript | 📅 2026-04-13: convert CSV to geojson
...
* [tokml](https://github.com/mapbox/tokml) ⭐ 193 | 🐛 10 | 🌐 JavaScript | 📅 2026-04-13: convert GeoJSON to KML
* [geomet](https://github.com/geomet/geomet) ⭐ 177 | 🐛 7 | 🌐 Python | 📅 2025-06-07: Pure Python conversion library for common geospatial data formats
...
* [betterknown](https://github.com/placemark/betterknown) ⭐ 57 | 🐛 4 | 🌐 TypeScript | 📅 2025-12-17: convert WKT to GeoJSON (successor to wellknown)
...
* [us-atlas](https://github.com/topojson/us-atlas) ⭐ 919 | 🐛 9 | 🌐 Shell | 📅 2024-01-02: geojson & topojson for United States features
* [france-geojson](https://github.com/gregoiredavid/france-geojson) ⭐ 814 | 🐛 17 | 📅 2022-12-02: Outlines of regions, departments, arrondissements, cantons and communes of France (mainland and overseas departments) in GeoJSON format
* [historical-basemaps](https://github.com/aourednik/historical-basemaps) ⭐ 706 | 🐛 32 | 🌐 JavaScript | 📅 2026-01-26: Collection of georeferenced boundaries of world countries and cultural regions for use in mapping historical data on the world scale.
...
* [mapbox-java](https://github.com/mapbox/mapbox-java) ⭐ 440 | 🐛 83 | 🌐 Java | 📅 2026-02-06: serialize GeoJSON to and from Java datatypes (based on [Gson](https://github.com/google/gson) ⭐ 24,211 | 🐛 337 | 🌐 Java | 📅 2026-04-23)
* [rust-geojson](https://github.com/georust/rust-geojson) ⭐ 336 | 🐛 25 | 🌐 Rust | 📅 2026-04-24: serialize geojson to/from rust datatypes
* [geojson-jackson](https://github.com/opendatalab-de/geojson-jackson) ⭐ 275 | 🐛 26 | 🌐 Java | 📅 2025-12-11: serialize GeoJSON to and from Java datatypes (based on [Jackson](http://wiki.fasterxml.com/JacksonHome))
