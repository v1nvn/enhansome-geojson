# awesome geojson [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 450,301 | 🐛 88 | 📅 2026-03-09
...
* [turf](https://github.com/Turfjs/turf) ⭐ 10,302 | 🐛 294 | 🌐 TypeScript | 📅 2026-03-29: collection of functions for spatial operations and analysi
...
* [turf\_dart](https://github.com/dartclub/turf_dart) ⭐ 82 | 🐛 56 | 🌐 Dart | 📅 2026-03-24: a turf.js port for Dart and Flutter
...
* [antimeridian](https://github.com/gadomski/antimeridian) ⭐ 107 | 🐛 5 | 🌐 Python | 📅 2026-03-30: Fix GeoJSON polygons that cross the antimeridian (Python package)
...
* [supercluster](https://github.com/mapbox/supercluster) ⭐ 2,312 | 🐛 42 | 🌐 JavaScript | 📅 2024-08-15: A fast GeoJSON clustering library for browsers and Node.
...
* [historical-basemaps](https://github.com/aourednik/historical-basemaps) ⭐ 690 | 🐛 14 | 🌐 JavaScript | 📅 2026-01-26: Collection of georeferenced boundaries of world countries and cultural regions for use in mapping historical data on the world scale.
...
* [mapbox-java](https://github.com/mapbox/mapbox-java) ⭐ 439 | 🐛 83 | 🌐 Java | 📅 2026-02-06: serialize GeoJSON to and from Java datatypes (based on [Gson](https://github.com/google/gson) ⭐ 24,332 | 🐛 335 | 🌐 Java | 📅 2026-03-19)
