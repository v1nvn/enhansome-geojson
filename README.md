# awesome geojson [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 447,077 | 🐛 86 | 📅 2026-03-09
...
* [turf](https://github.com/Turfjs/turf) ⭐ 10,289 | 🐛 292 | 🌐 TypeScript | 📅 2026-03-16: collection of functions for spatial operations and analysi
...
* [turf\_dart](https://github.com/dartclub/turf_dart) ⭐ 82 | 🐛 57 | 🌐 Dart | 📅 2026-03-19: a turf.js port for Dart and Flutter
...
* [Vector Tile Lab](https://github.com/spider-hand/vector-tile-lab) ⭐ 39 | 🐛 0 | 🌐 Vue | 📅 2026-03-03: An interactive sandbox to tune vector tiles
...
* [antimeridian](https://github.com/gadomski/antimeridian) ⭐ 106 | 🐛 3 | 🌐 Python | 📅 2026-03-16: Fix GeoJSON polygons that cross the antimeridian (Python package)
...
* [topojson](https://github.com/topojson/topojson) ⭐ 4,871 | 🐛 16 | 🌐 JavaScript | 📅 2024-09-20: convert GeoJSON to & from TopoJSON, join data from CSV
* [supercluster](https://github.com/mapbox/supercluster) ⭐ 2,310 | 🐛 42 | 🌐 JavaScript | 📅 2024-08-15: A fast GeoJSON clustering library for browsers and Node.
* [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,023 | 🐛 19 | 🌐 JavaScript | 📅 2024-06-26: Slice GeoJSON into vector tiles on the fly in the browser
...
* [historical-basemaps](https://github.com/aourednik/historical-basemaps) ⭐ 683 | 🐛 14 | 🌐 JavaScript | 📅 2026-01-26: Collection of georeferenced boundaries of world countries and cultural regions for use in mapping historical data on the world scale.
...
* [mapbox-java](https://github.com/mapbox/mapbox-java) ⭐ 439 | 🐛 82 | 🌐 Java | 📅 2026-02-06: serialize GeoJSON to and from Java datatypes (based on [Gson](https://github.com/google/gson) ⭐ 24,343 | 🐛 332 | 🌐 Java | 📅 2026-03-19)
* [rust-geojson](https://github.com/georust/rust-geojson) ⭐ 330 | 🐛 24 | 🌐 Rust | 📅 2026-03-16: serialize geojson to/from rust datatypes
