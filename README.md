# awesome geojson [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 460,724 | 🐛 68 | 📅 2026-04-19
...
* [turf](https://github.com/Turfjs/turf) ⭐ 10,354 | 🐛 300 | 🌐 TypeScript | 📅 2026-04-28: collection of functions for spatial operations and analysi
...
* [turf\_dart](https://github.com/dartclub/turf_dart) ⭐ 82 | 🐛 47 | 🌐 Dart | 📅 2026-04-30: a turf.js port for Dart and Flutter
...
* [topojson](https://github.com/topojson/topojson) ⭐ 4,879 | 🐛 16 | 🌐 JavaScript | 📅 2024-09-20: convert GeoJSON to & from TopoJSON, join data from CSV
...
* **OpenStreetMap**
  * [osmtogeojson](https://github.com/tyrasd/osmtogeojson) ⭐ 743 | 🐛 59 | 🌐 JavaScript | 📅 2026-04-23: convert OpenStreetMap data to GeoJSON
  * [query-overpass](https://github.com/perliedman/query-overpass) ⭐ 157 | 🐛 6 | 🌐 JavaScript | 📅 2023-03-28 CLI to make Overpass query and transform result to GeoJSON. Based on [osmtogeojson](https://github.com/tyrasd/osmtogeojson) ⭐ 743 | 🐛 59 | 🌐 JavaScript | 📅 2026-04-23
...
* [mapbox-java](https://github.com/mapbox/mapbox-java) ⭐ 439 | 🐛 83 | 🌐 Java | 📅 2026-02-06: serialize GeoJSON to and from Java datatypes (based on [Gson](https://github.com/google/gson) ⭐ 24,215 | 🐛 339 | 🌐 Java | 📅 2026-05-01)
