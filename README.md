# awesome geojson [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 454,670 | 🐛 62 | 📅 2026-04-02
...
* [turf](https://github.com/Turfjs/turf) ⭐ 10,317 | 🐛 295 | 🌐 TypeScript | 📅 2026-03-29: collection of functions for spatial operations and analysi
...
* [rfc7946-to-d3](https://github.com/tyrasd/rfc7946-to-d3) ⭐ 11 | 🐛 0 | 🌐 JavaScript | 📅 2018-05-28: Converts polygon winding order between rfc7946 and [d3 compatible](https://github.com/d3/d3-geo#d3-geo) ⭐ 1,092 | 🐛 34 | 🌐 JavaScript | 📅 2024-06-28 conventions.
...
* [geojson-pydantic](https://github.com/developmentseed/geojson-pydantic) ⭐ 280 | 🐛 7 | 🌐 Python | 📅 2026-04-10: [Pydantic](https://docs.pydantic.dev/latest/) models for GeoJSON
...
* [supercluster](https://github.com/mapbox/supercluster) ⭐ 2,316 | 🐛 42 | 🌐 JavaScript | 📅 2024-08-15: A fast GeoJSON clustering library for browsers and Node.
...
* [ogr2ogr](http://www.gdal.org/ogr2ogr.html): convert anything to anything
  * [fiona](https://github.com/toblerity/fiona) ⭐ 1,234 | 🐛 49 | 🌐 Python | 📅 2025-02-20: nice python interface on top of ogr
* **OpenStreetMap**
...
* [historical-basemaps](https://github.com/aourednik/historical-basemaps) ⭐ 700 | 🐛 14 | 🌐 JavaScript | 📅 2026-01-26: Collection of georeferenced boundaries of world countries and cultural regions for use in mapping historical data on the world scale.
...
* [mapbox-java](https://github.com/mapbox/mapbox-java) ⭐ 439 | 🐛 83 | 🌐 Java | 📅 2026-02-06: serialize GeoJSON to and from Java datatypes (based on [Gson](https://github.com/google/gson) ⭐ 24,245 | 🐛 339 | 🌐 Java | 📅 2026-04-10)
