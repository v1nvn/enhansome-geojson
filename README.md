# awesome geojson [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 438,982 | 🐛 70 | 📅 2026-01-28
...
* [turf](https://github.com/Turfjs/turf) ⭐ 10,246 | 🐛 288 | 🌐 TypeScript | 📅 2026-02-18: collection of functions for spatial operations and analysi
...
* [geojson-rewind](https://github.com/mapbox/geojson-rewind) ⭐ 133 | 🐛 5 | 🌐 JavaScript | 📅 2023-07-30: enforce ring winding order
...
* [Vector Tile Lab](https://github.com/spider-hand/vector-tile-lab) ⭐ 33 | 🐛 0 | 🌐 Vue | 📅 2026-02-17: An interactive sandbox to tune vector tiles
...
* [geojson-pydantic](https://github.com/developmentseed/geojson-pydantic) ⭐ 276 | 🐛 6 | 🌐 Python | 📅 2025-10-08: [Pydantic](https://docs.pydantic.dev/latest/) models for GeoJSON
* [geojsonhint](https://github.com/mapbox/geojsonhint) ⚠️ Archived: find errors in your geojson files
* [antimeridian](https://github.com/gadomski/antimeridian) ⭐ 105 | 🐛 3 | 🌐 Python | 📅 2025-12-15: Fix GeoJSON polygons that cross the antimeridian (Python package)
...
* [topojson](https://github.com/topojson/topojson) ⭐ 4,865 | 🐛 17 | 🌐 JavaScript | 📅 2024-09-20: convert GeoJSON to & from TopoJSON, join data from CSV
* [supercluster](https://github.com/mapbox/supercluster) ⭐ 2,304 | 🐛 42 | 🌐 JavaScript | 📅 2024-08-15: A fast GeoJSON clustering library for browsers and Node.
* [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,016 | 🐛 19 | 🌐 JavaScript | 📅 2024-06-26: Slice GeoJSON into vector tiles on the fly in the browser
* [ogr2ogr](http://www.gdal.org/ogr2ogr.html): convert anything to anything
  * [fiona](https://github.com/toblerity/fiona) ⭐ 1,225 | 🐛 47 | 🌐 Python | 📅 2025-02-20: nice python interface on top of ogr
* **OpenStreetMap**
...
* [tokml](https://github.com/mapbox/tokml) ⭐ 191 | 🐛 10 | 🌐 JavaScript | 📅 2018-05-06: convert GeoJSON to KML
...
* [france-geojson](https://github.com/gregoiredavid/france-geojson) ⭐ 803 | 🐛 17 | 📅 2022-12-02: Outlines of regions, departments, arrondissements, cantons and communes of France (mainland and overseas departments) in GeoJSON format
* [historical-basemaps](https://github.com/aourednik/historical-basemaps) ⭐ 668 | 🐛 13 | 🌐 JavaScript | 📅 2026-01-26: Collection of georeferenced boundaries of world countries and cultural regions for use in mapping historical data on the world scale.
...
* [mapbox-java](https://github.com/mapbox/mapbox-java) ⭐ 439 | 🐛 82 | 🌐 Java | 📅 2026-02-06: serialize GeoJSON to and from Java datatypes (based on [Gson](https://github.com/google/gson) ⭐ 24,356 | 🐛 330 | 🌐 Java | 📅 2026-02-16)
* [rust-geojson](https://github.com/georust/rust-geojson) ⭐ 326 | 🐛 28 | 🌐 Rust | 📅 2026-02-20: serialize geojson to/from rust datatypes
