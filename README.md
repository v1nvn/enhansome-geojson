# awesome geojson [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 466,102 | 🐛 75 | 📅 2026-05-05
...
* [turf](https://github.com/Turfjs/turf) ⭐ 10,364 | 🐛 304 | 🌐 TypeScript | 📅 2026-05-11: collection of functions for spatial operations and analysi
...
* [rfc7946-to-d3](https://github.com/tyrasd/rfc7946-to-d3) ⭐ 11 | 🐛 0 | 🌐 JavaScript | 📅 2018-05-28: Converts polygon winding order between rfc7946 and [d3 compatible](https://github.com/d3/d3-geo#d3-geo) ⭐ 1,096 | 🐛 34 | 🌐 JavaScript | 📅 2024-06-28 conventions.
...
* [supercluster](https://github.com/mapbox/supercluster) ⭐ 2,324 | 🐛 42 | 🌐 JavaScript | 📅 2024-08-15: A fast GeoJSON clustering library for browsers and Node.
* [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,031 | 🐛 15 | 🌐 JavaScript | 📅 2026-05-13: Slice GeoJSON into vector tiles on the fly in the browser
...
* [historical-basemaps](https://github.com/aourednik/historical-basemaps) ⭐ 714 | 🐛 32 | 🌐 JavaScript | 📅 2026-01-26: Collection of georeferenced boundaries of world countries and cultural regions for use in mapping historical data on the world scale.
...
* [rust-geojson](https://github.com/georust/rust-geojson) ⭐ 338 | 🐛 22 | 🌐 Rust | 📅 2026-04-29: serialize geojson to/from rust datatypes
